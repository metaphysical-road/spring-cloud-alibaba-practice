...
public class AccountTccActionImpl implements AccountTccAction {
    ...
    public boolean prepareDecreaseMoney(BusinessActionContext businessActionContext, Long userId, BigDecimal money) {
        System.out.println("减少账户金额，第一阶段锁定金额，userId=" + userId + "， money=" + money);
    ...
    public boolean commit(BusinessActionContext businessActionContext) {
        ...
        System.out.println("减少账户金额，第二阶段，提交，userId=" + userId + "， money=" + money);
    ...
    public boolean rollback(BusinessActionContext businessActionContext) {
        ...
        System.out.println("减少账户金额，第二阶段，回滚，userId=" + userId + "， money=" + money);
